...
public class IngredientDetails {
    ...
    //return ingredient name at index
    ...
    //return ingredient amount at index
    ...
    //return ingredient unit at index
    public static String getIngredientUnit(JSONArray ingredients, int index){
        try {
            return getCommonUnit( ingredients.getJSONObject(index).getString("unit") );
        } catch (JSONException e) {
            e.printStackTrace();
            return null;
        }
